                    ...
                    <div className=" mb-5" style={{width:"40%"}}>
                        ...
                        <div className=" mt-3 pb-5" style={{width:"80%", margin:"auto"}}>
                            ...
                            <div className="d-flex justify-content-between mt-3 text-center">
                                <div className=" bg-white rounded p-3" style={{height:"6rem", width:"45%", boxShadow:"6px 6px 6px grey"}}>
                            ...
                            <div className=" bg-white rounded mt-3 text-center d-flex justify-content-center" style={{boxShadow:"6px 6px 6px grey"}} >
